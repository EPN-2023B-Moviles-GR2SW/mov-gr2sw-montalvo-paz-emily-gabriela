...
class FRecyclerViewAdaptadorNombreDescripcion (
    ...
    private val recyclerView: RecyclerView)   : RecyclerView.Adapter< FRecyclerViewAdaptadorNombreDescripcion.MyViewHolder>(){
    ...
    inner class MyViewHolder(view: View) :RecyclerView.ViewHolder(view){
        ...
        init{
           ...
           likesTextView = view.findViewById(R.id.tv_likes)
            accionButton = view.findViewById(R.id.btn_darLike)
            accionButton.setOnClickListener{añadirLike()}
