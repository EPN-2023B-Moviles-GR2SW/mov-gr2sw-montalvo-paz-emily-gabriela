...
class IFireStore : AppCompatActivity() {
    ...
    private fun consultarIndiceCompuesto(
    ...
    private fun consultarCiudades(
        ...
        if (query == null) {
            ...
            // consulta de la consulta anterior empezando en el n
            tarea = query!!.get()
        }
        if (tarea != null) {
            tarea
    ...
    private fun eliminarRegistro() {
        ...
        referenciaEjemploEstudiante
            .document("12345678")
            .delete() // elimina
            .addOnSuccessListener { /* Si todo sale bien */ }
            .addOnFailureListener { /* Si algo sale mal */ }
    }
